...
- [**[01] 회원 데이터 삽입 (MEMBER)**: 500,000건](https://github.com/silxbro/database-project/blob/main/rentcar-db/data-creation/01_member.py)
- [**[02] 면허증 데이터 삽입 (DRIVER_LICENSE)**: 500,000건 - 회원(MEMBER)과 1:1 관계](https://github.com/silxbro/database-project/blob/main/rentcar-db/data-creation/02_driver-license.py)
- [**[03] 지점 데이터 삽입 (BRANCH)**: 100건](https://github.com/silxbro/database-project/blob/main/rentcar-db/data-creation/03_branch.py)
- [**[04] 지점 직원 데이터 삽입 (BRANCH_STAFF)**: 500\~2,000건 - 지점(BRANCH)와 1:M 관계(지점 당 5\~20명)](https://github.com/silxbro/database-project/blob/main/rentcar-db/data-creation/04_branch-staff.py)
- [**[05] 차량 모델 데이터 삽입 (CAR_MODEL)**: 67건](https://github.com/silxbro/database-project/blob/main/rentcar-db/data-creation/05_car-model.py)
- [**[06] 차량 데이터 삽입 (CAR)**: 5,000건](https://github.com/silxbro/database-project/blob/main/rentcar-db/data-creation/06_car.py)

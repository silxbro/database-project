...
- [**지점 직원(BRANCH_STAFF)**: 500\~2,000건 - 지점(BRANCH)와 1:M 관계(지점 당 5\~20명)](https://github.com/silxbro/database-project/blob/main/rentcar-db/data-creation/04_branch-staff.py)
- [**차량 모델(CAR_MODEL)**: 67건](https://github.com/silxbro/database-project/blob/main/rentcar-db/data-creation/05_car-model.py)

...
|**차량**|CAR| **차량ID**, 차량모델, 차량번호, 차량연식, 주행거리, 잔여유류량, 차량상태                                                     |
|**대여**|RENTAL| **대여ID**, 대여시작일자, 대여종료일자, 차량반납일자, 적용보험, 대여유류량, 반납유류량, 대여상태                                 |
...
| **사고이력-수리이력** | ACCIDENT | REPAIR | 1:1 |

#### ◼︎ ERD 다이어그램
<img src="https://github.com/user-attachments/assets/8ea17fac-a327-4318-a709-b73be7cfa152" width="1500" />
...
| is_discontinued | 단종여부    | BOOLEAN  | -   | NOT NULL |     |     |     |                       |
...
| rental_id          | 관련대여ID    | INT      | -    | NOT NULL |     | ●   |     | RENTAL 참조                |
| repair_id          | 관련수리ID    | INT      | -    | NOT NULL |     | ●   |     | REPAIR 참조                |

...
|**대여**|RENTAL| **대여ID**, 대여시작일자, 대여종료일자, 차량반납일자, 적용보험, 대여유류량, 반납유류량, 예약일자, 취소일자, 상태   |
...
| customer_name    | 회원명   | VARCHAR  | 50  | NOT NULL |     |     |    |                    |
...
| maker_name      | 제조사명    | VARCHAR  | 20  | NOT NULL |     |     |     |                             |
...
| insurance       | 적용보험    | VARCHAR  | 20  | NOT NULL  |     |     |      | 완전보험/부분보험/미적용        |
...
| fee_policy_id         | 적용정책ID    | INT      | -    | NULL     |     | ●   |     | RENTAL_FEE POLICY | INSURANCE_FEE_POLICY |<br/>DISCOUNT_POLICY | MILEAGE_POLICY 참조|         |
| payment_detail_type   | 결제상세항목   | VARCHAR  | 20   | NOT NULL |     |     |     | 대여료/보험료/할인금액/마일리지적립/마일리지사용 |
| amount                | 금액         | DECIMAL  | 20   | NOT NULL |     |     |     |                     |
...
| accident_location  | 사고발생장소   | VARCHAR  | 50   | NOT NULL |     |     |     |                           |
...
| management_detail  | 관리상세      | VARCHAR  | 20   | NOT NULL |     |     |     | 정기정비/수시정비/소모품교체/<br/>엔진수리/전기장치수리/외장수리/제동수리/기타|

...
|**대여**|RENTAL| **대여ID**, 대여차량, 대여자(운전자), 대여시작일자, 대여종료일자, 차량반납일자, 적용보험, 대여유류량, 반납유류량,<br/>예약일자, 취소일자, 상태 |
|**사고이력**|ACCIDENT| **사고이력ID**, 관련대여, 사고발생일시, 사고유형, 사고발생장소                                     |
|**결제내역**|PAYMENT| **결제ID**, 관련대여, 적용정책(요금/할인), 결제금액, 결제일시, 취소일시, 결제유형, 결제수단, 결제수단고유번호, 결제상태 |
...
| car_model_type  | 차량유형    | ENUM     | -   | NOT NULL |     |     |     | 경차/소형/중형/준대형/대형/<br/>승합/SUV・RV/전기차|                  
